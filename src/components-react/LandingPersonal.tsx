    ...
    <div className="hero-grid" style={{ maxWidth: '1100px', margin: '0 auto', display: 'grid', gridTemplateColumns: '55% 45%', gap: '5rem', alignItems: 'flex-start' }}>
      ...
      <div style={{ paddingTop: '3rem' }}>
        <h1 style={{
          ...
          Ils ont augmenté le volume de leurs clients<br/>Grâce à la publicité et notre système<br/><span style={{display:'inline-block', marginTop:'0.9rem'}}>
  ...
  <section id="etude-de-cas" style={{ backgroundColor: '#f5f4f0', padding: '5rem 2rem' }}>
    <div style={{ maxWidth: '900px', margin: '0 auto' }}>
      ...
      <p style={{ fontSize: '1.1rem', color: '#475569', fontWeight: 400, fontStyle: 'italic', lineHeight: 1.6, textAlign: 'center', margin: '0 0 1.5rem' }}>
        (La publicité a changé leur business avec notre système)
      </p>
