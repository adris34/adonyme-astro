          ...
          {steps.map((step, index) => {
            ...
            return (
              <motion.div
                ...
                className="bg-white rounded-2xl p-7 flex flex-col flex-shrink-0 w-[300px] md:w-[320px] transition-all duration-300 ease-out border border-transparent hover:border-white/80 hover:-translate-y-2"
